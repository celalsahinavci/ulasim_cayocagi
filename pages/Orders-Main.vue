...
import { VBtn, VCard, VCardText, VCardTitle, VDataTable, VDialog, VTextField, VCardActions, VChip } from 'vuetify/components'
    ...
    <v-row>
      ...
      <v-col cols="12">
        <v-card class="shadow-sm">
          <v-card-title class="bg-success text-white">Orders</v-card-title>
          <v-card-text>
            <v-data-table
              :headers="[ 
